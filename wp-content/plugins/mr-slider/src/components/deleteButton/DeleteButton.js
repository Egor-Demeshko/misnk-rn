            ...
            {popup && (
                    <Popover className="slider-editor__delete_popup_wrapper">
                        <div className="slider-editor__delete_popup">
                            <h4>{__('Вы уверены, что хотите удалить этот один слайд', 'rn-slider')}</h4>
                            <div className="slider-editor__delete_popup-buttons">
                                <Button variant="primary" onClick={cancel}>{__('Отмена', 'rn-slider')}</Button>
                                <Button isDestructive onClick={deleteSlide}>{__('Удалить', 'rn-slider')}</Button>
                            </div>
                        </div>
                    </Popover>
                )
